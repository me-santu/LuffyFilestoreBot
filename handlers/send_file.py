...
AUTODELETE_MESSAGE = os.getenv("from os import environ", '''‼️ File will auto delete in "{DELETE_TIME}" seconds😱 💡Forward it to saved massages or anywhere before downloading.😁 😇Join @Movies_X_Animes''')
